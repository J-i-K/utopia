...
export const en = {
  ...
  library: {
    ...
    rssFullModeHint:
      "The first successful sync records the current feed as a baseline and imports nothing. Later new items use feed content first, then a guarded article fetch, with summary fallback.",
    rssFeedModeHint:
