...
Background extraction and entity adjudication can opt into the Codex Responses transport through an explicit Compose overlay. The default deployment remains Chat Completions. Interactive streamed chat and embeddings are not changed by this switch.
